...
jest.mock("@traduxo/packages/utils/translation/swapMainTranslation", () => {
  const original = jest.requireActual("@traduxo/packages/utils/translation/swapMainTranslation");
  return {
    __esModule: true,
