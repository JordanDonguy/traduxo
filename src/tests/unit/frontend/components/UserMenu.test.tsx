...
// ChangePassword Mock
jest.mock("@/components/ChangePassword", () => {
...
jest.mock("@/components/TranslationHistory", () => {
...
jest.mock("@/components/FavoriteTranslations", () => {
...
jest.mock("@/components/ExplanationLanguage", () => {
