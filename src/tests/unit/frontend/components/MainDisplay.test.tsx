...
jest.mock("@/lib/client/hooks/useFavoriteToggle", () => ({
  useFavoriteToggle: () => ({
...
jest.mock("@/lib/client/hooks/useSwitchTranslations", () => ({
...
jest.mock("@/lib/client/utils/authToasts", () => ({
...
// Landing Display
jest.mock("@/components/LandingDisplay", () => {
...
jest.mock("@/components/TranslationSection", () => {
...
jest.mock("@/components/ExplanationSection", () => {
