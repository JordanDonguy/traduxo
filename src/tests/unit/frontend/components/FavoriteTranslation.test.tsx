...
import FavoriteTranslation from "@/components/FavoriteTranslations";
...
// --- Mocks ---
jest.mock("@/lib/client/hooks/useFavoriteTranslations");
jest.mock("@/lib/client/hooks/useSelectTranslation");
