...
import ExplanationLanguage from "@/components/ExplanationLanguage";
...
// ------ Mocks ------
jest.mock("@/lib/client/hooks/useExplanationLanguage");
jest.mock("@/lib/client/utils/sortedLanguageCodes");
jest.mock("iso-639-1", () => ({
  getName: jest.fn(),
}));
