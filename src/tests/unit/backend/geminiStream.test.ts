...
// Async generator simulating Gemini streaming chunks
async function* fakeStream(): AsyncGenerator<GenerateContentResponse> {
  yield { text: 'Hello', data: undefined, functionCalls: [], executableCode: undefined, codeExecutionResult: undefined };
  yield { text: ' ', data: undefined, functionCalls: [], executableCode: undefined, codeExecutionResult: undefined };
  yield { text: 'world!', data: undefined, functionCalls: [], executableCode: undefined, codeExecutionResult: undefined };
}
